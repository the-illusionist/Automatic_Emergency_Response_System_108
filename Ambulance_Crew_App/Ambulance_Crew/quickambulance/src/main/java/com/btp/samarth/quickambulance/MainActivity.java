...
import com.btp.samarth.quickambulance.adapter.NavDrawerListAdapter;
import com.btp.samarth.quickambulance.model.NavDrawerItem;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regId =((Variables) this.getApplication()).getamb_regId();
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                break;
            case 2:
                fragment = new WaytoHospitalFragment();
                break;
            case 3:
                fragment = new EndTripFragment();
                break;
            case 4:
